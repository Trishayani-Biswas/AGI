...
- [priority=+0.635; upside=0.81; confidence=0.80; risk=0.18] Run a matched curriculum-vs-baseline ablation extension (+8 seeds) under fixed settings.
- [priority=+0.548; upside=0.85; confidence=0.57; risk=0.22] Execute a shock-probability sweep (0.02/0.03/0.04) to verify innovation advantage stability.
